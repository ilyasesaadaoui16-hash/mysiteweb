...
const translations = {
    ar: {
        ...
        about_desc: "أنا إلياس سعداوي، متخصص في البنية التحتية الرقمية مع تركيز على الأنظمة والشبكات. أحمل شهادة CCNA وأطمح لتوظيف مهاراتي التقنية في بيئة مهنية ديناميكية، مع تعميق معرفتي في مجال الأمن السيبراني والمساهمة في مشاريع مبتكرة تحمي البنى الرقمية وتدعم التحول الرقمي.",
